...
class DetalleFactura
{
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="factura_idfactura", referencedColumnName="idfactura", nullable=false)
     * })
     */
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="producto_idproducto", referencedColumnName="idproducto", nullable=false)
     * })
     */
