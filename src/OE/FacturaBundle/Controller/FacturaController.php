...
use OE\FacturaBundle\Entity\Factura;
...
class FacturaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $facturas = $em->getRepository('FacturaBundle:Factura')->findAll();
    ...
    {
        $factura = new Factura();
        $form = $this->createForm('OE\FacturaBundle\Form\FacturaType', $factura);
    ...
    {
        $deleteForm = $this->createDeleteForm($factura);
        $editForm = $this->createForm('OE\FacturaBundle\Form\FacturaType', $factura);
